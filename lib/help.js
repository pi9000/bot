    ...
    options = {
        reply_markup: {
            inline_keyboard: [
                ...
                [
                    { text: 'Sans Menu', callback_data: 'sans-' + user_id },
                ],
                [
                    { text: 'NuLz Tools 🛠️', callback_data: 'nulz-' + user_id },
                ],
            ]
        }
    }
...
exports.nulz = async(lol, user_id) => {
    prefix = config.prefix
    text = `NuLz Tools :

❏ ${prefix}cekipo domain/url
❏ ${prefix}cekip ipaddress
❏ ${prefix}ceknik NIK(Nomor Induk Kependudukan)
`
...
exports.sans = async(lol, user_id) => {
    prefix = config.prefix
    text = `Sans Menu :
